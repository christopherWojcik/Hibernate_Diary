...
public class MessageGenerator {
    ...
    public void initMessage() {
        System.out.println("+=================================================================================+");
        System.out.println("|  --------         Hello, this is simple application - Diary.          --------  |");
        System.out.println("+=================================================================================+");
        System.out.println("|          This App has been made by Krzysztof Wójcik during SDA course.          |");
        System.out.println("|             Stack used in this project: Hibernate, MySQL, Java 11.              |");
        System.out.println("+=================================================================================+");
    }
    ...
    public void userLoginDuplicate() {
        System.out.println("+---------------------------------------------------------------------------------+");
        System.out.println("|        Entered login is already in database! You must create new one :)         |");
        System.out.println("+---------------------------------------------------------------------------------+");
    }
